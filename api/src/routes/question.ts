...
export async function addQuestion(req: Request, res: Response) {
  ...
  switch (question_type) {
    ...
    case "linearscale-answer": {
      newQuestion = new linearscaleQuestion({ ...common, lowRating: [...lowRating], highRating: [...highRating], lowRatingLabel: [...lowRatingLabel], highRatingLabel: [...highRatingLabel]});
      break;
    }

    case "multiplechoicegrid-answer": {
      newQuestion = new multiplechoicegridQuestion({ ...common , rowLabel: [...rowLabel], colLabel: [...colLabel]});
      break;
    }

    case "checkboxgrid-answer": {
      newQuestion = new checkboxgridQuestion({ ...common, rowLabel: [...rowLabel], colLabel: [...colLabel] });
      break;
    }
